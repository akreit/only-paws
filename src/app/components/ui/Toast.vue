      ...
      <TransitionGroup name="toast">
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <button
              type="button"
              class="inline-flex flex-shrink-0 text-gray-400 hover:text-gray-500 focus:outline-none"
...
function toastClasses(type: string) {
  const base =
    'max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden p-4'
  const colors = {
