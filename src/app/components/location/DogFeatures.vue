  ...
  <div class="rounded-lg bg-white p-6 shadow-md">
    ...
    <div class="space-y-4">
      ...
      <div v-if="location.leashRequired !== null" class="flex items-start gap-3">
        ...
        <div>
          <p class="font-medium text-gray-900">
            Leash {{ location.leashRequired ? 'Required' : 'Optional' }}
          </p>
      ...
      <div v-if="amenities.length > 0" class="flex items-start gap-3">
        <svg
          class="mt-0.5 h-5 w-5 flex-shrink-0 text-purple-600"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
          <path
        ...
        <div>
          <p class="mb-2 font-medium text-gray-900">Amenities</p>
          <div class="flex flex-wrap gap-2">
            <span
              v-for="amenity in amenities"
              :key="amenity"
              class="rounded-full bg-purple-50 px-2 py-1 text-sm text-purple-700"
            >
              {{ amenity }}
            </span>
          </div>
      ...
      <!-- No Features -->
      <div v-if="!hasFeatures" class="py-8 text-center text-gray-500">
        <svg
