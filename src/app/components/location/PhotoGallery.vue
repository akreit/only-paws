  ...
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div v-if="photos.length > 0" class="grid grid-cols-2 sm:grid-cols-3 gap-4">
      <div
        ...
        :key="photo.id"
        class="relative aspect-square cursor-pointer rounded-lg overflow-hidden hover:opacity-90 transition-opacity"
    ...
    <div v-else class="text-center py-12 text-gray-500">
      ...
      <p>No photos yet</p>
      <p v-if="isSignedIn" class="text-sm mt-1">Be the first to add photos!</p>
    </div>
